...
@section('dynamicdata')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{!! route('admin.project.list') !!}">Project Location</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    {!! Form::model($projectLocation, ['url' => route('admin.project-location.update', ['id' => $projectLocation->id]), 'method' => 'PUT', 'id' => 'project-location-create-form', 'enctype' => "multipart/form-data"]) !!}
