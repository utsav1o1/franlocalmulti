            ...
            <div class="row">
                <div class="detail-print-container">
                    <ul class="nav detail-print">
                        ...
                        <li>
                            <a class="btn btn-info detail-btn" id="inquiry-us-button" href="#has-inquiry-tab">Enquire
                                Now</a>
                        </li>
                    </ul>
                </div>
                            ...
                            <div class="agent-short-contact">
                                ...
                                <p>
                                    <a href="tel:{!! $agent->mobile_number !!}"><i
                                            class="glyphicon glyphicon-phone"></i>{!! substr($agent->mobile_number,0,4).
                    ...
                    <div class="tab-content">
                        ...
                        <div id="inquiry" @if(session('success_message') || session('warning_message') ||
                            ...
                            <div>
                                ...
                                <form action="{!! route('properties.submit.contact', $property->id) !!}" method="post">
                                    ...
                                    <div class="row agent-field">
                                        ...
                                        <div class="col-sm-10 col-md-10">
                                            <textarea type="text" class="form-control agent-form-control" name="message"
                                                rows="4" placeholder="Leave your message"
