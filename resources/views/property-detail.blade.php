                                        ...
                                        <div class="row custom-top-spacing single-gallery-row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="property-gallery">
                                                    <div id="carouselSliderIndicators" class="carousel slide"
                                                        data-ride="carousel">
                                                        <ol class="carousel-indicators">
                                                            <?php
                                                    ...
                                                    ?>
                                                            ...
                                                            <li data-target="#carouselSliderIndicators"
                                                                data-slide-to="{{$index}}"
                                                        ...
                                                        <a class="left carousel-control"
                                                            href="#carouselSliderIndicators" data-slide="prev">
                                                            <span class="glyphicon glyphicon-chevron-left"></span>
                                                            <span class="sr-only">Previous</span>
                                                        </a>
                                                        <a class="right carousel-control"
                                                            href="#carouselSliderIndicators" data-slide="next">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <div class="detail-print-container">
                                                    <ul class="nav detail-print">
                                                        ...
                                                        <li><a href="https://multidynamicingleburn.com.au"
                                                        ...
                                                        <li class="fb-share">
                                                            <div class="fb-share-button fb_iframe_widget"
                                                                ...
                                                                <span
                                                                    style="vertical-align: bottom; width: 89px; height: 28px;"><iframe
                                                    ...
                                                    <div class="thumbnail recent-properties-box">
                                                        ...
                                                        <div class="caption detail">
                                                            ...
                                                            <div class="detail-footer">
                                                                ...
                                                                <a href="#agent-details-navigation"><i
                                                                        class="fa-user"></i>
                                                                    {{ $property->property_agent ?? 0 }}
                                                                    {{ ($property->property_agent < 2) ? 'agent'
                                                                        : 'agents' }}</a>
                                                ...
                                                <div class="property-details content-box">
                                                    ...
                                                    <div class="row">
                                                        <ul class="row">
                                                            ...
                                                            <li class="col-lg-6">
                                                                <label>Price:</label> {{$property->price_view ??
                                                                "Contact Agent"}}
                                                            </li>
                                                            <li class="col-lg-6">
                                                                <label>Property Size:</label>{{$property->area ?? "Not
                                                                available"}}
                                                            </li>
                                                            <li class="col-lg-6">
                                                                <label>Bedrooms:</label> {{$property->number_of_bedrooms
                                                                ?? 0}}
                                                            </li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <div class="features-details content-box">
                                                    ...
                                                    <div class="tab-content">
                                                        <div id="description" @if(session('success_message') ||
                                                            session('warning_message') || count($errors)> 0)
                                                            class="tab-pane fade"
                                                        ...
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading" role="tab" id="headingThree">
                                                                <h4 class="panel-title">
                                                                    <button class="collapsed" role="button"
                                                            ...
                                                            <div id="collapseThree" class="panel-collapse collapse"
                                                                ...
                                                                <div class="panel-body">
                                                                    <div class="plan-image">
                                                                        <img src="{{$property->floor_plan_1 ?? null}}"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="video content-box">
                                                    ...
                                                    <div class="video__block">
                                                        <iframe width="100%" height="315"
                                                            src="{{$property->video_link ?? null}}">
                                                        </iframe>
                                                        <a href="#" class="link"><i
                                                                class="icon fa fa-play text-white"></i></a>
                                                    </div>
                                                </div>
                                                @endif
                                                <!-- end div content-box  -->
                                                    ...
                                                    <div>
                                                        ...
                                                        {{-- <ul class="nav nav-tabs" role="tablist">
                                                            <li role="presentation" class="active"><a href="#primary"
                                                                    aria-controls="primary" role="tab"
                                                                    data-toggle="tab">Primary </a>
                                                            </li>
                                                            <li role="presentation"><a href="#profile"
                                                                    aria-controls="profile" role="tab"
                                                                    data-toggle="tab">Secondary</a></li>
                                                            <li role="presentation"><a href="#child-care"
                                                                    aria-controls="child-care" role="tab"
                                                            ...
                                                            <div role="tabpanel" class="tab-pane active" id="primary">
                                                                <div class="content-wrapper">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-7">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-4">Independent
                                                                                    </div>
                                                                    ...
                                                                    <div class="final-link">
                                                                        <button class="btn btn-default">"Distance" is a
                                                                            straight line
                                                                            calculation.
                                                                            See more about our child care and schools
                                                                            data.
                                                                        </button>
                                                                        <div class="final-collapse-content">We receive
                                                                            schools data from
                                                                            government
                                                                            agencies, schools, real estate agents and
                                                                            the general public.
                                                                            Childcare
                                                                            data is provided by KN Enrol Pty Ltd. We
                                                                            update our data from
                                                                            regular
                                                                            updates and feedback received. "Distance"
                                                                            refers to the straight
                                                                            line
                                                                            between the property and the school or child
                                                                            care address on our
                                                                            database. We recommend contacting schools
                                                                            and child cares
                                                                            directly
                    ...
                    ?>
                                            ...
                                            <div class="col-lg-3 property_sidebar">
                                                ...
                                                <div class="agent-wrapper">
                                                    ...
                                                    <div class="agent-text">
                                                        <h5 style="height: 27px;">
                                                            <a href="#">
                                                                {{ str_limit($propertyAgent->first_name . ' ' .
                                                                $propertyAgent->last_name, 16) }}
                                                            </a>
                                                        </h5>
                                                ...
                                                <div class="list-group property-search-sidebar-container">
                                                    <div class="wrapper">
                                                        <p
                                                            class="list-group-item side-bar-head property-search-sidebar-header">
                                                            Search
                                                            Property</p>
                                                        <form action="{{route('properties.search')}}" method="get"
                                                            ...
                                                            <div class="col-md-12 slide-category">
                                                                <select class="form-control type" name="category">
                                                                    ...
                                                                    @foreach(DataHelper::getCategories() as
                                                                    $key=>$category)
                                                            ...
                                                            <div class="col-md-12 slider-loc">
                                                                <input type="text"
                                                                    ...
                                                                    id="location" placeholder="Choose Location"
                                                                    autocomplete="off">
                                                            ...
                                                            <div class="col-md-12">
                                                                <select class="form-control property_type"
                                                                    ...
                                                                    @foreach(DataHelper::getPropertyTypes() as
                                                                    $key=>$type)
                                                            ...
                                                            <div class="col-md-12">
                                                                <select class="form-control price_range"
                                                                    name="price_range">
                                                                    ...
                                                                    <option value="1000000-100000000000">$1M Over
                                                                    </option>
                                                                </select>
                                                            </div>
                                                            <div class="col-md-12">
                                                ...
                                                <div class="list-group">
                                                    <p class="list-group-item side-bar-head">Recently Added Properties
                                                    </p>
