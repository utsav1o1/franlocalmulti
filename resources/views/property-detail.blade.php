...
@section('footer_js')
    ...
    <script type="text/javascript"
        src="https://maps.googleapis.com/maps/api/js?key={{ env('GOOGLE_MAP_KEY') }}&sensor=false&libraries=places">
    </script>
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#save-property').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        swal('Success', response.message, 'success');
                        $($object).parent('li').html(
                            '<button class="btn btn-info btn-lg detail-btn"><span class="glyphicon glyphicon-pushpin"></span>Saved</button>'
                        );
                    },
                    ...
                    <div class="col-lg-4">
                        <span class="wdp-ribbon wdp-ribbon-six">
                            <span class="wdp-ribbon-inner-wrap">
                                ...
                                @endif
                                @if (
                                    $property->is_leased_sold == 'Y' &&
                                        $property->property_category_id == '1' &&
                                        $property->property_status == 'Under Contract')
                                ...
                                @if (
                                    $property->is_leased_sold == 'Y' &&
                                        $property->property_category_id == '2' &&
                                ...
                                @if (
                                    $property->is_leased_sold == 'Y' &&
                                        $property->property_category_id == '2' &&
                                        $property->property_status == 'Deposit Taken')
                                    <span class="wdp-ribbon-text-long">
                                        DEPOSIT TAKEN
                                    </span>
                                @endif
                        ...
                        <div class="single-title-block">
                            <h1>{{ $property->street_number . ' ' . $property->street . ' ' . $property->location_name ?? '' }}
                            </h1>
                        </div>
                        ...
                        <div class="detail-print-container">
                            <ul class="nav detail-print">
                                ...
                                <li class="fb-share">
                                    <div class="fb-share-button fb_iframe_widget" data-href="{!! route('properties.show', $property->slug) !!}"
                                        data-layout="button_count" data-size="large" data-mobile-iframe="true"
                                        fb-xfbml-state="rendered" fb-iframe-plugin-query="{!! 'app_id=911895265634736&amp;container_width=60&amp;href=' .
                                            $encoded_url .
                                            '&amp;layout=button_count&amp;locale=en_US&amp;mobile_iframe=true&amp;sdk=joey&amp;size=large' !!}">
                                        <span style="vertical-align: bottom; width: 89px; height: 28px;"><iframe
                                                ...
                                                src="{!! 'https://www.facebook.com/v2.10/plugins/share_button.php?app_id=911895265634736&amp;channel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df26a287e52fcbe4%26domain%' .
                                                    $domain .
                                                    '%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%' .
                                                    $domain .
                                                    '%252Ff27311465998866%26relation%3Dparent.parent&amp;container_width=60&amp;href=' .
                                                    $encoded_url .
                                                    '&amp;layout=button_count&amp;locale=en_US&amp;mobile_iframe=true&amp;sdk=joey&amp;size=large' !!}" class="" width="1000px" height="1000px"
                ...
                <div class="row custom-top-spacing">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="description content-box">
                            <h2>{{ $property->name ?? '' }}</h2>
                            <h4>{{ $property->street_number . ' ' . $property->street . ' ' . $property->location_name ?? '' }}
                            </h4>
                        ...
                        @endif
                        <!-- end div content-box  -->
                        @if (isset($property->floor_plan_1) || isset($property->floor_plan_2) || isset($property->floor_plan_3))
                        ...
                        <!-- @if (!empty($property->video_link))
                            {{-- Debugging to display video link --}}
                    ...
                    <div class="col-lg-4 property_sidebar">
                                ...
                                @foreach ($propertyAgents as $index => $propertyAgent)
                                    <div class="agent-wrapper">
                                        ...
                                        <div class="agent-image">
                                            <a class="agent-detail-link" href="{!! route('agents.show', $propertyAgent->getCustomId()) !!}">
                                            ...
                                            <div class="agent-short-contact">
                                                <p>
                                                    <a href="tel:{{ $propertyAgent->phone_number ?? '' }}"><i
                                                            class="glyphicon glyphicon-phone-alt"></i>{{ $propertyAgent->phone_number ?? '' }}</a>
                                                </p>

                                                <p>
                                                    <a href="tel:{{ $propertyAgent->mobile_number ?? '' }}"><i
                                                            class="glyphicon glyphicon-phone"></i>{{ $propertyAgent->mobile_number ?? '' }}</a>
                                                </p>

                                                <p>
                                                    <a href="mailto:{{ $propertyAgent->email }}"><i
                                                            class="glyphicon glyphicon-envelope"></i>{{ str_limit($propertyAgent->email, 15) }}...</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-sm-6 col-12 left">
                                        ...
                                        {!! Form::text('first_name', null, [
                                            'class' => 'form-control agent-form-control',
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        @if ($errors->has('g-recaptcha-response'))
                                            <small
                                                class="validation-error-message">{{ $errors->get('g-recaptcha-response')[0] }}</small>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="list-group">
                            ...
                            @foreach ($recentProperties as $index => $recentProperty)
                                <a href="{!! route('properties.show', $recentProperty->slug) !!}" class="list-group-item">{!! $recentProperty->name !!}</a>
                            @endforeach
                        ...
                        <div class="list-group">
                            ...
                            @foreach ($popularProperties as $index => $viewedProperty)
                                <a href="{!! route('properties.show', $viewedProperty->slug) !!}" class="list-group-item">{!! $viewedProperty->name !!}</a>
                            @endforeach
                        </div>
                        ...
                        <div class="list-group">
                            ...
                            @foreach ($similarProperties as $index => $similarProperty)
                                <a href="{!! route('properties.show', $similarProperty->slug) !!}" class="list-group-item">{!! $similarProperty->name !!}</a>
                            @endforeach
