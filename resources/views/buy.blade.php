        ...
        <div class="container">
            <div class="row">
                ...
                <div class="tab-content clearfix">
                    @foreach($categories as $index=>$pcatgory)
                    <div id="{!! $pcatgory->slug !!}" class="tab-pane fade in @if($slug == $pcatgory->slug) {{ 'active' }} @endif">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <center>
                                    <font color="#0c5aa0">
                                        @if($category)
                                            <h4 align="center" style="margin:0px; padding: 0px;"><b>{!! $category->short_description !!}</b></h4>
                                        @endif
                                    </font>
                                </center>
                            </div>
