                    ...
                    <ul class="nav nav-tabs">
                        @foreach($categories as $index=>$pcatgory)
                            <li @if($slug==$pcatgory->slug) class="active" @endif>
                                <a data-toggle="tab"
                                   href="#{!! $pcatgory->slug !!}">{!! ucwords($pcatgory->name) !!}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
                                        ...
                                        <div class="thumbnail">
                                            ...
                                            <!--Caption Detail-->
                                                    ...
                                                    <header>
                                                        ...
                                                        <div class="price-block">
                                                            ...
                                                            <div class="price">
                                                                ...
                                                                <?php }
                                                                else if($property->price_type_name == "Sold Price") { ?>
                                                                <span style="font-size: 12px">{{ str_limit( $property->sold_price_text,22)}}</span>
                                                                <?php }
                                                                else { ?>
                                                ...
                                                <div class="view-detail">
                                                    <a href="{!! route('properties.show', $property->slug) !!}">View
                                                        Detail</a>
                                                </div>
                                                <!-- view more button  -->
                                            </div>
