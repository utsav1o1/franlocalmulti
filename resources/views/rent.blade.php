            ...
            <div class="row">
                <div class="inner-menu-bg col-md-12">
                    <ul class="nav nav-tabs">
                        <li @if($slug == 'residential') class="active" @endif><a data-toggle="tab" href="#residential">Residential</a>
                        </li>
                        <li><a href="{!! route('agents.index') !!}">Commercial</a></li>
                        </li>
                        <li class="">
                            <a href="#" class="dropdown-toggle first"
                               data-toggle="dropdown" role="button" aria-haspopup="true"
                               aria-expanded="false">Forms <span class="caret"></span>
                            </a>
                            <ul class="dropdown dropdown-menu">
                                <li><a href="{!! asset('storage/Tenancy-Application-Form-2018.pdf') !!}" target="_blank">Application</a>
                                </li>
                                <li><a href="{!! asset('storage/Landlord-Information-Book-2017-MD.pdf') !!}">Owner</a></li>
                                <li><a href="{!! asset('storage/Master-Appraisal-Letter-of-MD-by-Bish.docx') !!}">Master Appraisal Letter</a></li>
                ...
                <div class="tab-content clearfix">
                    <div id="residential" class="tab-pane fade in @if($slug == DataHelper::getRentResidentialSlug()) {{ 'active' }} @endif">
                        <form method="get" action="{!! route('properties.rent', DataHelper::getRentResidentialSlug()) !!}"
                              class="form-group-lg clearfix">
                            @include('layouts.rent-search')
                        </form>
                    </div>
                    <div id="unit" class="tab-pane fade in @if($slug == 'unit') {{ 'active' }} @endif">
                        <form method="get" action="{!! route('properties.rent', 'unit') !!}"
                              class="form-group-lg clearfix">
                            @include('layouts.rent-search')
                        </form>
                    </div>
                        ...
                        <div class="inner-search-row">
                            <div class="col-sm-12 col-md-12">
                                <div class="col-sm-12 col-md-12">
                                    <font color="#f26522">
                                        <h1 class="rent-resi">
                                            <b>@if($category) {!!  $category->name !!} @else {{ 'Search Results' }} @endif</b>
                                        </h1>
                                    </font>
                                    <h4>
                                                ...
                                                <div class="caption detail">
                                                    <header>
                                                        <div class="pull-left inner-pull-left">
                                                            <h1 class="title">
                                                                <a href="{!! route('properties.show', $property->slug) !!}">{!! str_limit($property->name, 20) !!}</a>
                                                            </h1>
                                                        </div>
                                                        <div class="price">
