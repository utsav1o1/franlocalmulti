            ...
            <div class="row">
                <div class="inner-menu-bg col-md-12">
                    <ul class="nav nav-tabs">
                        ...
                        {{-- <li ><a data-toggle="tab" href="#residential">Residential</a>
                    </li>
                    <li @if ($slug == 'commercial') class="active" @endif><a href="https://auburn.multidynamic.com.au/rent/commercial">Commercial</a></li>
                    </li> --}}
                        <li class="">
                ...
                <div id="appartment" class="tab-pane fade in @if ($slug == 'appartment') {{ 'active' }} @endif">
                    ...
                    @foreach ($categories as $index => $pcatgory)
                        <div id="{!! $pcatgory->slug !!}"
                            ...
                            <form method="get" action="{!! route('properties.rent', $pcatgory->slug) !!}" class="clearfix form-group-lg">
                                @include('layouts.rent-search')
                            </form>
                        </div>
                    @endforeach
                                                ...
                                                <div class="caption detail">
                                                    <header>
                                                        <div class="pull-left inner-pull-left">
                                                            <h1 class="title">
                                                                <a
                                                                    href="{!! route('properties.show', $property->slug) !!}">{!! str_limit($property->street_number . ' ' . $property->street . ' ' . $property->location_short_name, 30) !!}</a>
                                                            </h1>
                                                        </div>
                                                        <div class="price">
