...
@section('footer_js')
    <script category="text/javascript">
        $(document).ready(function () {
            ...
            $('#agentAddForm').find('[name="amenities"]')
                .each(function () {
                    $(this)
                        .ckeditor()
                        .editor
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!--
                        /.box-body
                    -->            <!-- form start -->
                    <form role="form" id="agentAddForm" name="agentAddForm" action="{!! route('agent.property.store') !!}"
                        ...
                        <div class="box-body">
                            <div class="form-group col-md-8">
                                ...
                                <input type="text" class="form-control" name="property_name"
                                       value="{!! old('property_name') !!}" placeholder="Enter property name">
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" class="form-control" name="price" value="{!! old('price') !!}" data-required="1">
                            </div>
                            <div class="form-group col-md-2" style="display: none;">
                                <label for="exampleInputAgent">Price To</label>
                                <input type="number" class="form-control" name="price_to" value="{!! old('price_to') !!}"/>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="exampleInputAgent">Area  In Square meter</label>
                                <input type="decimal" class="form-control" name="area"
                                       value="{!! old('area') !!}" step-size="0.01">
                            </div>
                        </div>
                        ...
                        <fieldset class="gllpLatlonPicker">
                            ...
                            <div class="box-body">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" data-required="1" class="gllpZoom" name="zoom" value="4">
