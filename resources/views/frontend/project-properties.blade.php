                                    ...
                                    @if($property->coverImage)
                                        @if(file_exists('storage/properties/'.$property->id.'/'.$property->coverImage->thumb_attachment ) && $property->coverImage->thumb_attachment != '')
                                            <img src="{!! asset('storage/properties/'.$property->id.'/'.$property->coverImage->thumb_attachment) !!}"
                                                 alt="{!! $property->property_name !!}" class="img-responsive"/>
                                        @else
                                            <img src="{!! asset('images/appartment.jpg') !!}"
                                                 alt="{!! $property->property_name !!}" class="img-responsive"/>
                                        @endif
                                    @else
                                        <img src="{!! asset('images/appartment.jpg') !!}"
                            ...
                            <!--Caption Detail-->
                                <div class="caption detail">
                                    <header>
                                        <div class="pull-left">
                                            <h1 class="title">
                                                <a href="{!! route('properties.show', $property->slug) !!}">{!! str_limit($property->property_name, 20) !!}</a>
                                            </h1>
                                        </div>
                                    ...
                                    <div class="detail-footer">
                                        @if($property->agent)
                                            <a href="{!! route('properties.show', $property->slug) !!}"><i
                                                        class="fa-user"></i> {!! $property->agent->first_name.' '.$property->agent->last_name !!}
                                            </a>
                                        @endif
