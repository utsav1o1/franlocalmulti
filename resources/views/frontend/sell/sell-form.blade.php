...
<div class="container sell-form-container">
	<div class="row">
		<div class="col-md-12">
		...
		<div class="col-md-12">
			<div class="vacate-notice-container">
				...
				<div class="form-group col-md-4">
					...
					{!! Form::select('bedrooms', ['0' => '0', '1' => '1', '2' => '2', '3' => '3', '4' => '4+'], null,
					['class' => 'form-control']) !!}
				...
				<div class="form-group col-md-4">
					...
					{!! Form::select('bathrooms', ['0' => '0', '1' => '1', '1.5' => '1.5', '2' => '2', '2.5' => '2.5',
					'3' => '3+'], null, ['class' => 'form-control']) !!}
				...
				<div class="form-group col-md-4">
					<label>Garages</label>
					{!! Form::select('garages', ['0' => '0', '1' => '1', '2' => '2', '3' => '3', '4' => '4+'], null,
					['class' => 'form-control']) !!}
