                        ...
                        <ul class="nav navbar-nav top-main-menu">
                            ...
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown">
                                    ...
                                    <li>
                                        <a
                                            href="{{ route('project-locations.show-project-locations', ['projectType' => $projectType->slug]) }}">{!!
                                            $projectType->name !!}</a>
                                    </li>
                                    @endforeach
                                </ul>
                            ...
                            <li class="">
                                <a href="{!! route('properties.buy') !!}" class="dropdown-toggle" data-toggle="dropdown"
                                    role="button" aria-haspopup="true" aria-expanded="false">Buy
                            ...
                            <li class="">
                                <a href="{!! route('properties.rent') !!}" class="dropdown-toggle"
                                    data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Rent
                                    <span class="caret"></span></a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{!! route('contact-us.form') !!}">Contact
                                    Us</a>
                            </li>
                        </ul>
                        <ul class="topsocialnav">
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button"
                                    ...
                                    $user->full_name)[0]) !!}<span class="caret"></span></a>
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-linka dropdown-toggle" data-toggle="dropdown" role="button"
                                    aria-haspopup="true" aria-expanded="false">Sign In &nbsp;<span
                                        class="caret"></span></a>
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-linka" data-toggle="modal"
                                    data-target=".bs-example-modal-lg">Book An
                                    Appraisal</a>
