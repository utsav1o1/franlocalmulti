...
<body style="background-color: #fff; padding: 20px; ">
    <div style="max-width: 680px; background-color: #f0f0f0; margin: auto; ">
        <img width="100%" src="https://storage.googleapis.com/geonet-public/Multi%20Dynamic/headerMD.png" alt="" />
        <div style="padding: 30px;">
            ...
            <p>Call us today to find out what we can do for you.</p>
