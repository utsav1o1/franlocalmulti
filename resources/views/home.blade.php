                            ...
                            <div class="thumbnail recent-properties-box">
                                ...
                                <div class="caption detail">
                                    <header>
                                        <div class="pull-left">
                                            <h2 class="title">
                                                <a href="{!! route('properties.show', $property->slug) !!}">{!! str_limit($property->street_number . ' ' . $property->street . ' ' . $property->location_short_name) !!}</a>
                                            </h2>
                                        </div>
                                        ...
                                        <div class="price-block">
                                            ...
                                            <div class="price">
                                                ...
                                                <span
                                                    style="font-size: 12px">{{ str_limit($property->price_view, 22) }}</span>
                                                <?php }?>
                                            </div>
                                        </div>
                                        <!--Area Block-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="mesage-content">
                                Multi Dynamic Real Estates is one of the most trusted and fastest-growing real estate
                                franchises in Australia. Our dedicated, educated and the hardworking auburn team has a
                                proven track record of results in serving our customers to buy, sell, rent, and build their
                                properties. You can be assured when you engage Multi Dynamic Auburn, you will find every
                                solution to your real estate requirements because it's our client's satisfaction that is the
                                key to our success.
                            </div>
                        </div>
                ...
                @if (!empty($home->selling))
                    <div class="col-lg-4">
                        <div class="free-guides-block">
                            ...
                            <a href="{{ url($home->selling->getFilePath()) }}" class="btn btn-warning"
                                data-toggle="modal" data-target="#sellingModal">Download
                                Seller’s Guide</a>
                        </div>
                    </div>
                @endif
                @if (!empty($home->buying))
                    <div class="col-lg-4">
                        <div class="free-guides-block">
                            ...
                            <a href="{{ url($home->buying->getFilePath()) }}" class="btn btn-warning"
                                data-toggle="modal" data-target="#buyingModal">Download
                                Buyer’s Guide</a>
                        </div>
                    </div>
                @endif
                                ...
                                <div class="blog-link">
                                    ...
                                    <div class=" blog-short-details-container">
                                        <div class="blog-link-heading">
                                            <a
                                                href="{{ route('page.blog', ['slug' => $blog->slug]) }}">{{ $blog->title }}</a>
                                        </div>
                                        <div class="blog-short-descriptions">{{ str_limit($blog->description, 120) }}
                                        </div>
                            ...
                            <div class="team__slider__item">
                                <div class="team__block">
                                    ...
                                    <div class="team__content">
                                        <h3>{{ $agent->getFullName() }}<em>{!! $agent->designation ? $agent->designation->designation : '' !!}</em></h3>
                                    </div>
                                    <div class="team-links">
                                        <ul>
                                            <li><a href="tel:{{ $agent->phone_number }}"><img
                                                        src="{{ asset('') }}images/telephone.png" alt=""></a>
                                            </li>
                                            <li><a href="tel:{{ $agent->mobile_number }}"><img
                                                        src="{{ asset('') }}images/mobile.png" alt=""></a></li>
                                            <li><a href="mailto:{{ $agent->email }}"><img
                                                        src="{{ asset('') }}images/message.png" alt=""></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <ul>
                        @foreach ($posts as $insta_post)
                            <li class="insta-gallery-block">
                                <div class="image">
                                    <a href="javascript:void(0)"><img src="{{ asset('insta/images/' . $insta_post) }}"
                                            alt="" target="_blank"></a>
                                </div>
