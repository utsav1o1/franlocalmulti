                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 agent-block">
                                        <div class="agent-wrapper">
                                            <div class="agent-image">
                                                <a href="{!! route('agents.show', encrypt($agent->id)) !!}">
                                                @if(file_exists('storage/agents/'. $agent->attachment) && $agent->attachment != '')
                                                <img src="{!! asset('storage/agents/'. $agent->attachment) !!}"
                                            ...
                                            <div class="agent-text">
                                                ...
                                                <div class="agent-short-contact">
                                                    ...
                                                    <p>
                                                        <a href="mailto:{!! $agent->email_address !!}"><i class="glyphicon glyphicon-envelope"></i>{!! str_limit($agent->email_address, 20) !!}</a>
                                                    </p>
                                                    @endif
                                                </div>
                                            </div>
